...
<div class="location-section location-section-main">
	...
	<span id="location-label"><?php echo ifset( $display_name, __( 'None', 'simple-location' ) ); ?></span>
	...
	<div id="location-fields" class="field-row hide-if-js">
		<label for="address"><?php _e( 'Textual Description:', 'simple-location' ); ?></label>
		<input type="text" name="address" id="address" value="<?php echo ifset( $geodata['address'] ); ?>" class="widefat" data-role="none" />

	<label for="location"><?php _e( 'Location:', 'simple-location' ); ?></label>
	<?php
